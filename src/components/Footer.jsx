        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-3">
              ...
              <h3 className="text-lg font-bold text-white">Sudipta Panda</h3>
            </div>
            ...
            <div className="border-t border-gray-700 pt-4 mt-4">
              ...
              <div className="flex flex-wrap gap-2">
                {[
                  ...
                  { 
                    name: 'Instagram',
                    href: 'https://www.instagram.com/s.sudiptapanda', 
                    label: 'Instagram',
                  ...
                  { 
                    name: 'Facebook',
                    href: 'https://www.facebook.com/sudipta.panda.465656', 
                    label: 'Facebook',
                  ...
                  { 
                    name: 'LinkedIn',
                    href: 'https://www.linkedin.com/in/sudiptapanda03', 
                    label: 'LinkedIn',
                  ...
                  { 
                    name: 'Discord',
                    href: 'https://discord.gg/sudiptapanda', 
                    label: 'Discord',
                  ...
                  { 
                    name: 'Gmail',
                    href: 'mailto:sudiptapanda546@gmail.com', 
                    label: 'Gmail',
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-start space-x-2">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <p className="text-gray-300 text-sm">Bhubaneswar, Odisha, India</p>
                </div>
              </div>
          ...
          <div className="flex flex-col lg:flex-row justify-between items-center space-y-4 lg:space-y-0">
            <div className="text-center lg:text-left">
              <p className="text-gray-400 text-sm">
                © {currentYear} Sudipta Panda. All rights reserved.
              </p>
              <p className="text-gray-500 text-xs mt-1">
                Built with React & Tailwind CSS • Deployed on Replit
              </p>
            </div>
